...
/* if(var.equals("가위"))//사용자가 가위를 냈다면
            ...
            else if(var.equals("바위"))//사용자가 바위를 냈다면
            {
                if (str[n].equals("가위"))//컴퓨터가 낸 것이 "바위"인지 비교하는 문
                    tmp=1;
                else if(str[n].equals("바위"))//컴퓨터가 낸 것이 "바위"인지 비교하는 문
                    tmp=0;
                else if(str[n].equals("보"))
            ...
            else if(var.equals("보"))//사용자가 보를 냈다면
            {
                if (str[n].equals("가위"))//컴퓨터가 낸 것이 "보"인지 비교하는 문
                    tmp=2;
                else if(str[n].equals("바위"))//컴퓨터가 낸 것이 "바위"인지 비교하는 문
                    tmp=1;
                else if(str[n].equals("보"))
